...
console.log(user);
    ...
    return(
        <div style = {{marginTop: '89px', marginRight: '60px', marginLeft: '60px'}}>

            <div className="row utters-sm" >
                <div className="col-md-4 mb-3">

                    <div className="card">
                    <div className="card-body">
                    <div className="d-flex flex-column align-items-center text-center">
                        <ProfileImage user={user} size='70px'/>
                        <div className="mt-3">
                        <h4>{user.username}</h4>
                    ...
                    <div className="card mb-3">
                        <div className="card-body">
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-sm-9 text-secondary">New Delhi</div>
                            </div>
                            ...
                            <div className="row mb-4">
                                ...
                                <div className="col-sm-9 text-secondary">500</div>
                            </div>
                        ...
                        <div className="col-sm-9 mb-3">
                            <div className="card h-100">
                                ...
                                <div className="card-body">
                                    ...
                                    <h6 className="d-flex align-items-center mb-4"><i className="material-icons text-info mr-2">Skills</i> Learnt</h6>
                                    ...
                                    <div className="row mb-4">
                                        ...
                                        <div className="col-sm-7 text-secondary">Hip-Hop</div>
                                    ...
                                    <div className="col-sm-5">
                                        ...
                                        <div className="col-sm-7 text-secondary">3 hr</div>                                                                          
                                    </div>
                                    ...
                                    <div className="col-sm-5">
                                        ...
                                        <div className="col-sm-7 text-secondary">Ricky Park</div>                                    
                                    </div>                                  
                                </div>
                            </div>
                        </div>
                    ...
                    {/* <div className="col-sm-9 mb-3">
                        ...
                        <div className="card h-100">
                            ...
                            <div className="card-body">
                                ...
                                <h6 className="d-flex align-items-center mb-4"><i className="material-icons text-info mr-2">Courses</i> Offered</h6>
                                
                                <div className="row mb-4">
                                    <div className="col-sm-5">
                                    <h6 className="mb-0">Course Name</h6>
                                    </div>
                                    <div className="col-sm-7 text-secondary">StandUp Comedy</div>                                                                        
                                </div>
                                ...
                                <div className="col-sm-7 text-secondary">1 hr</div>                                                                          
                                </div>                            
